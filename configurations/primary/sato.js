...
// Coin Configuration
config.primary.coin = {};
config.primary.coin.name = 'Sato';
config.primary.coin.symbol = 'SATO';
...
config.primary.coin.mainnet.peerMagic = '63566565';
config.primary.coin.mainnet.pubKeyHash = Buffer.from('3f', 'hex').readUInt8(0);
...
config.primary.coin.mainnet.coin = 'sato';
...
config.primary.coin.testnet.coin = 'tsato';
...
config.primary.payments.daemon.port = 3334;
